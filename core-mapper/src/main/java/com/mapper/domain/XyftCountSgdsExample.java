...
public class XyftCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public XyftCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table xyft_count_sgds
     *
     * @mbggenerated
     */
