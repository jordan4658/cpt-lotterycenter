...
public class JsauspksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsauspksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JsauspksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsauspks_count_sgdx
     *
     * @mbggenerated
     */
