...
public class JsauspksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsauspksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public JsauspksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsauspks_kill_number
     *
     * @mbggenerated
     */
