...
public class FivepksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivepksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FivepksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivepks_lottery_sg
     *
     * @mbggenerated
     */
