...
public class TensscCountSgdxdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TensscCountSgdxdsExample() {
     ...
     * @mbggenerated
     */
    public TensscCountSgdxdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenssc_count_sgdxds
     *
     * @mbggenerated
     */
