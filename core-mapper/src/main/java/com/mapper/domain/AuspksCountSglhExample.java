...
public class AuspksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_count_sglh
     *
     * @mbggenerated
     */
