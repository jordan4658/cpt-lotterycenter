...
public class FtxyftKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtxyftKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FtxyftKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftxyft_kill_number
     *
     * @mbggenerated
     */
