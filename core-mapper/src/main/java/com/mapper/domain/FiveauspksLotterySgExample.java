...
public class FiveauspksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveauspksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FiveauspksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveauspks_lottery_sg
     *
     * @mbggenerated
     */
