...
public class JsauspksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsauspksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JsauspksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsauspks_count_sgds
     *
     * @mbggenerated
     */
