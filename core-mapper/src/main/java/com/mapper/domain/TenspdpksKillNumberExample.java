...
public class TenspdpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenspdpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TenspdpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenspdpks_kill_number
     *
     * @mbggenerated
     */
