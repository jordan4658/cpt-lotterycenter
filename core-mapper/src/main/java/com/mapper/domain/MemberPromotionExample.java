...
public class MemberPromotionExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public MemberPromotionExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table member_promotion
     *
     * @mbggenerated
     */
