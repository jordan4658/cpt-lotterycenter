...
public class FtxyftCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtxyftCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftxyft_count_sgds
     *
     * @mbggenerated
     */
