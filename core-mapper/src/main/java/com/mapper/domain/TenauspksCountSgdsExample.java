...
public class TenauspksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenauspksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public TenauspksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenauspks_count_sgds
     *
     * @mbggenerated
     */
