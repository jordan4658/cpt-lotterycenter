...
public class JsspdpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsspdpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public JsspdpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsspdpks_count_sglh
     *
     * @mbggenerated
     */
