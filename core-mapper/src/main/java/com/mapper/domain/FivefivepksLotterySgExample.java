...
public class FivefivepksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivefivepksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FivefivepksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivefivepks_lottery_sg
     *
     * @mbggenerated
     */
