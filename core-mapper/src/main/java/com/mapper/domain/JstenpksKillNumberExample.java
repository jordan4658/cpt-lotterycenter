...
public class JstenpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JstenpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public JstenpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jstenpks_kill_number
     *
     * @mbggenerated
     */
