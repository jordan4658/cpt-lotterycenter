...
public class TentenpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TentenpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public TentenpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tentenpks_lottery_sg
     *
     * @mbggenerated
     */
