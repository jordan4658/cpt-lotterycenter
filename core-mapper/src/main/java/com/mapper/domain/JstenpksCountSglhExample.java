...
public class JstenpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JstenpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public JstenpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jstenpks_count_sglh
     *
     * @mbggenerated
     */
