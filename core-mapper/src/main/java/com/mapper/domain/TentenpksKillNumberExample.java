...
public class TentenpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TentenpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TentenpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tentenpks_kill_number
     *
     * @mbggenerated
     */
