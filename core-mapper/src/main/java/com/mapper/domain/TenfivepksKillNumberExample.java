...
public class TenfivepksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenfivepksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TenfivepksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenfivepks_kill_number
     *
     * @mbggenerated
     */
