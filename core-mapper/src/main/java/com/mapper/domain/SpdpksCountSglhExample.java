...
public class SpdpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public SpdpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table spdpks_count_sglh
     *
     * @mbggenerated
     */
