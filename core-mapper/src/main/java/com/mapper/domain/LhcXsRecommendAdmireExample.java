...
public class LhcXsRecommendAdmireExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LhcXsRecommendAdmireExample() {
     ...
     * @mbggenerated
     */
    public LhcXsRecommendAdmireExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
