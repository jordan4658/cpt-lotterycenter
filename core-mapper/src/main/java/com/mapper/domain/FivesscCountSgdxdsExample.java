...
public class FivesscCountSgdxdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivesscCountSgdxdsExample() {
     ...
     * @mbggenerated
     */
    public FivesscCountSgdxdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivessc_count_sgdxds
     *
     * @mbggenerated
     */
