...
public class FivebjpksRecommendExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivebjpksRecommendExample() {
     ...
     * @mbggenerated
     */
    public FivebjpksRecommendExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivebjpks_recommend
     *
     * @mbggenerated
     */
