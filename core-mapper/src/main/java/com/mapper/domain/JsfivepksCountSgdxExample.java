...
public class JsfivepksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsfivepksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JsfivepksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsfivepks_count_sgdx
     *
     * @mbggenerated
     */
