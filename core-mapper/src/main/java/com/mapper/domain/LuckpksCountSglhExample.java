...
public class LuckpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LuckpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public LuckpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table luckpks_count_sglh
     *
     * @mbggenerated
     */
