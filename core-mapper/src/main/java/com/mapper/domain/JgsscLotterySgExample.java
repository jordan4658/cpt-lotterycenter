...
public class JgsscLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JgsscLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jgssc_lottery_sg
     *
     * @mbggenerated
     */
