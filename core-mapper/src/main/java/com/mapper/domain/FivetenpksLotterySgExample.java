...
public class FivetenpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivetenpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FivetenpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivetenpks_lottery_sg
     *
     * @mbggenerated
     */
