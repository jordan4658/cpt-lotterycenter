...
public class LuckpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LuckpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public LuckpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table luckpks_lottery_sg
     *
     * @mbggenerated
     */
