...
public class TentenpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TentenpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TentenpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tentenpks_count_sglh
     *
     * @mbggenerated
     */
