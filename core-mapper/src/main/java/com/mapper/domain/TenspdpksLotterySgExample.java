...
public class TenspdpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenspdpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public TenspdpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenspdpks_lottery_sg
     *
     * @mbggenerated
     */
