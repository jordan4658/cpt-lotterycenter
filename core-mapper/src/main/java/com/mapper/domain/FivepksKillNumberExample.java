...
public class FivepksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivepksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FivepksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivepks_kill_number
     *
     * @mbggenerated
     */
