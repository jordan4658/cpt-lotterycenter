...
public class JstenpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JstenpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JstenpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jstenpks_count_sgds
     *
     * @mbggenerated
     */
