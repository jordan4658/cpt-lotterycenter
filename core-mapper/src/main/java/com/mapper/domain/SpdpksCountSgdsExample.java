...
public class SpdpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public SpdpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table spdpks_count_sgds
     *
     * @mbggenerated
     */
