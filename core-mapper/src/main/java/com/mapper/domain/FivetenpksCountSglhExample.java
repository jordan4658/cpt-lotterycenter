...
public class FivetenpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivetenpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FivetenpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivetenpks_count_sglh
     *
     * @mbggenerated
     */
