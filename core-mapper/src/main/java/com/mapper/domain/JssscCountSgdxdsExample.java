...
public class JssscCountSgdxdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JssscCountSgdxdsExample() {
     ...
     * @mbggenerated
     */
    public JssscCountSgdxdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsssc_count_sgdxds
     *
     * @mbggenerated
     */
