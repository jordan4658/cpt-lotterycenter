...
public class NoLotteryRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public NoLotteryRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table no_lottery_record
     *
     * @mbggenerated
     */
