...
public class TenspdpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenspdpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TenspdpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenspdpks_count_sglh
     *
     * @mbggenerated
     */
