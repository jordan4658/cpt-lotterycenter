...
public class AuspksRecommendExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksRecommendExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_recommend
     *
     * @mbggenerated
     */
