...
public class RepealBetOrderExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public RepealBetOrderExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table repeal_bet_order
     *
     * @mbggenerated
     */
