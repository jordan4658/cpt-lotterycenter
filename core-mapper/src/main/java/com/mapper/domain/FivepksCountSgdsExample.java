...
public class FivepksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivepksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FivepksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivepks_count_sgds
     *
     * @mbggenerated
     */
