...
public class JsspdpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsspdpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JsspdpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsspdpks_count_sgdx
     *
     * @mbggenerated
     */
