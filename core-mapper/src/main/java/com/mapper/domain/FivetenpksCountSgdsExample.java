...
public class FivetenpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivetenpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FivetenpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivetenpks_count_sgds
     *
     * @mbggenerated
     */
