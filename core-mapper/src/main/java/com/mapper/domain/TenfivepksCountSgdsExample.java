...
public class TenfivepksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenfivepksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public TenfivepksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenfivepks_count_sgds
     *
     * @mbggenerated
     */
