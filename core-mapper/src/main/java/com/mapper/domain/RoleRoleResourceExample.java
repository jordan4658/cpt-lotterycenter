...
public class RoleRoleResourceExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public RoleRoleResourceExample() {
     ...
     * @mbggenerated
     */
    public RoleRoleResourceExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table role_role_resource
     *
     * @mbggenerated
     */
