...
public class TenauspksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenauspksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TenauspksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenauspks_kill_number
     *
     * @mbggenerated
     */
