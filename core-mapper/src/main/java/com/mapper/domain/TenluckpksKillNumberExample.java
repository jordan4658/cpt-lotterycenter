...
public class TenluckpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenluckpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public TenluckpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenluckpks_kill_number
     *
     * @mbggenerated
     */
