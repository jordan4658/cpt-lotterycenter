...
public class TentenpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TentenpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TentenpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tentenpks_count_sgdx
     *
     * @mbggenerated
     */
