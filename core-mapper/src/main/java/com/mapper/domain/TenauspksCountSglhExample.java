...
public class TenauspksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenauspksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TenauspksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenauspks_count_sglh
     *
     * @mbggenerated
     */
