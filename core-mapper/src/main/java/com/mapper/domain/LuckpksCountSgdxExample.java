...
public class LuckpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LuckpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public LuckpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table luckpks_count_sgdx
     *
     * @mbggenerated
     */
