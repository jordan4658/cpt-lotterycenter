...
public class FivefivepksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivefivepksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FivefivepksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivefivepks_count_sglh
     *
     * @mbggenerated
     */
