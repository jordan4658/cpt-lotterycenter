...
public class LuckpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LuckpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public LuckpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table luckpks_count_sgds
     *
     * @mbggenerated
     */
