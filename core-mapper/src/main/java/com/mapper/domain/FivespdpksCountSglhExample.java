...
public class FivespdpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivespdpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FivespdpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivespdpks_count_sglh
     *
     * @mbggenerated
     */
