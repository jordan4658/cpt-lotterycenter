...
public class FivespdpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivespdpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FivespdpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivespdpks_lottery_sg
     *
     * @mbggenerated
     */
