...
public class FivespdpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivespdpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FivespdpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivespdpks_count_sgdx
     *
     * @mbggenerated
     */
