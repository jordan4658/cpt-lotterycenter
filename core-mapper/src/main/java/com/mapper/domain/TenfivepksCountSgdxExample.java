...
public class TenfivepksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenfivepksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TenfivepksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenfivepks_count_sgdx
     *
     * @mbggenerated
     */
