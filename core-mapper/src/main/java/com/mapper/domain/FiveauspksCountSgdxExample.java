...
public class FiveauspksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveauspksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FiveauspksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveauspks_count_sgdx
     *
     * @mbggenerated
     */
