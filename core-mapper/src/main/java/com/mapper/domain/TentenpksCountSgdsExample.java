...
public class TentenpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TentenpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public TentenpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tentenpks_count_sgds
     *
     * @mbggenerated
     */
