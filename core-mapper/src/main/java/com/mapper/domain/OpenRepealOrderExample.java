...
public class OpenRepealOrderExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public OpenRepealOrderExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table open_repeal_order
     *
     * @mbggenerated
     */
