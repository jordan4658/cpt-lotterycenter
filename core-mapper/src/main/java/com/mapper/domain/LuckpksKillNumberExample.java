...
public class LuckpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LuckpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public LuckpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table luckpks_kill_number
     *
     * @mbggenerated
     */
