...
public class FiveauspksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveauspksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FiveauspksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveauspks_count_sgds
     *
     * @mbggenerated
     */
