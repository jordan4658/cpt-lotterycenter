...
public class TenpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenpks_count_sglh
     *
     * @mbggenerated
     */
