...
public class XyftCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public XyftCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table xyft_count_sgdx
     *
     * @mbggenerated
     */
