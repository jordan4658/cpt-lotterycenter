...
public class TenpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenpks_count_sgdx
     *
     * @mbggenerated
     */
