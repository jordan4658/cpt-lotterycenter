...
public class FivesscCountSgdxds implements Serializable {
    /**
     * 字段: fivessc_count_sgdxds.id<br/>
     * 主键: 自动增长<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
    ...
    /**
     * 字段: fivessc_count_sgdxds.date<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 19<br/>
     * 说明: 日期
    ...
    /**
     * 字段: fivessc_count_sgdxds.one<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 1出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.two<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 2出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.three<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 3出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.four<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 4出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.five<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 5出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.six<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 6出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.seven<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 7出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.eight<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 8出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.nigh<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 9出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.ten<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 10(或者0)出现的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.big<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 出现大的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.small<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 出现小的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.odd<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 出现单的次数
    ...
    /**
     * 字段: fivessc_count_sgdxds.even<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 出现双的次数
     ...
     * This field corresponds to the database table fivessc_count_sgdxds
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.id: 
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.date: 日期
     *
     * @mbggenerated
     */
    public Date getDate() {
    ...
    /**
     * @return fivessc_count_sgdxds.one: 1出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.two: 2出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.three: 3出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.four: 4出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.five: 5出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.six: 6出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.seven: 7出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.eight: 8出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.nigh: 9出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.ten: 10(或者0)出现的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.big: 出现大的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.small: 出现小的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.odd: 出现单的次数
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_count_sgdxds.even: 出现双的次数
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        FivesscCountSgdxds other = (FivesscCountSgdxds) that;
