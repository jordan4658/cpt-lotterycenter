...
public class FivetenpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivetenpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FivetenpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivetenpks_kill_number
     *
     * @mbggenerated
     */
