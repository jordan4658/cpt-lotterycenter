...
public class TenluckpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenluckpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TenluckpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenluckpks_count_sgdx
     *
     * @mbggenerated
     */
