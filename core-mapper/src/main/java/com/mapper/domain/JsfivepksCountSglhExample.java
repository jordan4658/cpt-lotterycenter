...
public class JsfivepksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsfivepksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public JsfivepksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsfivepks_count_sglh
     *
     * @mbggenerated
     */
