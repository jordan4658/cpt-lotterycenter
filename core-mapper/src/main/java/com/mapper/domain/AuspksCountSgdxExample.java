...
public class AuspksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_count_sgdx
     *
     * @mbggenerated
     */
