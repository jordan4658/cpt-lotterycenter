...
public class RepealStartlottoExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public RepealStartlottoExample() {
     ...
     * @mbggenerated
     */
    public RepealStartlottoExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table repeal_startlotto
     *
     * @mbggenerated
     */
