...
public class TenauspksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenauspksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TenauspksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenauspks_count_sgdx
     *
     * @mbggenerated
     */
