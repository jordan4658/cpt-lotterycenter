...
public class GatherFailureRecordExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public GatherFailureRecordExample() {
     ...
     * @mbggenerated
     */
    public GatherFailureRecordExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table gather_failure_record
     *
     * @mbggenerated
     */
