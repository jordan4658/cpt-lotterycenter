...
public class TenspdpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenspdpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public TenspdpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenspdpks_count_sgdx
     *
     * @mbggenerated
     */
