...
public class FtxyftCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtxyftCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftxyft_count_sglh
     *
     * @mbggenerated
     */
