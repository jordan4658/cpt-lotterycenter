...
public class FivespdpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivespdpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FivespdpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivespdpks_count_sgds
     *
     * @mbggenerated
     */
