...
public class FivesscKillNumber implements Serializable {
    /**
     * 字段: fivessc_kill_number.id<br/>
     * 主键: 自动增长<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
    ...
    /**
     * 字段: fivessc_kill_number.issue<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 期号
    ...
    /**
     * 字段: fivessc_kill_number.open_one<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 第一球开奖结果
    ...
    /**
     * 字段: fivessc_kill_number.ball_one<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
    ...
    /**
     * 字段: fivessc_kill_number.open_two<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 第二球开奖结果
    ...
    /**
     * 字段: fivessc_kill_number.ball_two<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
    ...
    /**
     * 字段: fivessc_kill_number.open_three<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 第三球开奖结果
    ...
    /**
     * 字段: fivessc_kill_number.ball_three<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
    ...
    /**
     * 字段: fivessc_kill_number.open_four<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 第四球开奖结果
    ...
    /**
     * 字段: fivessc_kill_number.ball_four<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
    ...
    /**
     * 字段: fivessc_kill_number.open_five<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
     * 说明: 第五球开奖结果
    ...
    /**
     * 字段: fivessc_kill_number.ball_five<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
     * 说明: 第五球杀号
    ...
    /**
     * 字段: fivessc_kill_number.time<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 时间
    ...
    /**
     * @return fivessc_kill_number.issue: 期号
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.open_one: 第一球开奖结果
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.ball_one: 第一球杀号（sin,sec,cos,cot,tan）
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.open_two: 第二球开奖结果
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.ball_two: 第二球杀号（sin,sec,cos,cot,tan）
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.open_three: 第三球开奖结果
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.ball_three: 第三球杀号（sin,sec,cos,cot,tan）
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.open_four: 第四球开奖结果
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.ball_four: 第四球杀号（sin,sec,cos,cot,tan）
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.open_five: 第五球开奖结果
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.ball_five: 第五球杀号
     *
     * @mbggenerated
     */
    ...
    /**
     * @return fivessc_kill_number.time: 时间
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        FivesscKillNumber other = (FivesscKillNumber) that;
