...
public class JsspdpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsspdpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JsspdpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsspdpks_count_sgds
     *
     * @mbggenerated
     */
