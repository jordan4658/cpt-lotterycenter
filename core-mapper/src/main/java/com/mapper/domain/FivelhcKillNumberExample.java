...
public class FivelhcKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivelhcKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FivelhcKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivelhc_kill_number
     *
     * @mbggenerated
     */
