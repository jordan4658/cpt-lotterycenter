...
public class FiveluckpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveluckpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FiveluckpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveluckpks_count_sgds
     *
     * @mbggenerated
     */
