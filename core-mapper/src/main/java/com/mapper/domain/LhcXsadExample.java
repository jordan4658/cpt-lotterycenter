...
public class LhcXsadExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public LhcXsadExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table lhc_xsad
     *
     * @mbggenerated
     */
