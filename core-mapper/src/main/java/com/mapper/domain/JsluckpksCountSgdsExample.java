...
public class JsluckpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsluckpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JsluckpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsluckpks_count_sgds
     *
     * @mbggenerated
     */
