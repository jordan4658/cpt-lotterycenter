...
public class SpdpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public SpdpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table spdpks_count_sgdx
     *
     * @mbggenerated
     */
