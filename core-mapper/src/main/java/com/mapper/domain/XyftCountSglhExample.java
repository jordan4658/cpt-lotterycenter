...
public class XyftCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public XyftCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table xyft_count_sglh
     *
     * @mbggenerated
     */
