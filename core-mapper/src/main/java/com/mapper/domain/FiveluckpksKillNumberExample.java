...
public class FiveluckpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveluckpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FiveluckpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveluckpks_kill_number
     *
     * @mbggenerated
     */
