...
public class FtjspksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtjspksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FtjspksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftjspks_count_sgds
     *
     * @mbggenerated
     */
