...
public class FiveauspksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveauspksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FiveauspksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveauspks_count_sglh
     *
     * @mbggenerated
     */
