...
public class FivepksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivepksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FivepksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivepks_count_sgdx
     *
     * @mbggenerated
     */
