...
public class TenfivepksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenfivepksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public TenfivepksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenfivepks_lottery_sg
     *
     * @mbggenerated
     */
