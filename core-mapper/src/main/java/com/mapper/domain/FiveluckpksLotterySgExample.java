...
public class FiveluckpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveluckpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public FiveluckpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveluckpks_lottery_sg
     *
     * @mbggenerated
     */
