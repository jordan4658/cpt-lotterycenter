...
public class XyftKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public XyftKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table xyft_kill_number
     *
     * @mbggenerated
     */
