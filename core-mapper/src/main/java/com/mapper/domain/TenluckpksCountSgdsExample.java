...
public class TenluckpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenluckpksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public TenluckpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenluckpks_count_sgds
     *
     * @mbggenerated
     */
