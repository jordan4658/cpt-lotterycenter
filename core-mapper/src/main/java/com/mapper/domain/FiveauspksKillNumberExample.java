...
public class FiveauspksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FiveauspksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public FiveauspksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fiveauspks_kill_number
     *
     * @mbggenerated
     */
