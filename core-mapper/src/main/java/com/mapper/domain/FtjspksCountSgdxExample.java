...
public class FtjspksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtjspksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FtjspksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftjspks_count_sgdx
     *
     * @mbggenerated
     */
