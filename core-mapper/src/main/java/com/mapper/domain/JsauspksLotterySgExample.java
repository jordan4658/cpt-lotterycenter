...
public class JsauspksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsauspksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JsauspksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsauspks_lottery_sg
     *
     * @mbggenerated
     */
