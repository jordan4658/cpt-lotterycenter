...
public class JsfivepksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsfivepksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JsfivepksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsfivepks_lottery_sg
     *
     * @mbggenerated
     */
