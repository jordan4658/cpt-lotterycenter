...
public class TenluckpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenluckpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TenluckpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenluckpks_count_sglh
     *
     * @mbggenerated
     */
