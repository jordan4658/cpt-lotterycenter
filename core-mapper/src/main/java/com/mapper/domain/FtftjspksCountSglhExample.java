...
public class FtftjspksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtftjspksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FtftjspksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftftjspks_count_sglh
     *
     * @mbggenerated
     */
