...
public class JsspdpksLotterySg implements Serializable {
    /**
     * 字段: jsspdpks_lottery_sg.id<br/>
     * 主键: 自动增长<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 10<br/>
    ...
    /**
     * 字段: jsspdpks_lottery_sg.issue<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 20<br/>
     * 说明: 期号
    ...
    /**
     * 字段: jsspdpks_lottery_sg.number<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 开奖号码
    ...
    /**
     * 字段: jsspdpks_lottery_sg.time<br/>
     * 必填: false<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 实际开奖时间
    ...
    /**
     * 字段: jsspdpks_lottery_sg.ideal_time<br/>
     * 必填: true<br/>
     * 缺省: <br/>
     * 长度: 50<br/>
     * 说明: 官方开奖时间
    ...
    /**
     * 字段: jsspdpks_lottery_sg.open_status<br/>
     * 必填: true<br/>
     * 缺省: WAIT<br/>
     * 长度: 50<br/>
     ...
     * This field corresponds to the database table jsspdpks_lottery_sg
     *
     * @mbggenerated
     */
    ...
    /**
     * @return jsspdpks_lottery_sg.issue: 期号
     *
     * @mbggenerated
     */
    ...
    /**
     * @return jsspdpks_lottery_sg.number: 开奖号码
     *
     * @mbggenerated
     */
    ...
    /**
     * @return jsspdpks_lottery_sg.time: 实际开奖时间
     *
     * @mbggenerated
     */
    ...
    /**
     * @return jsspdpks_lottery_sg.ideal_time: 官方开奖时间
     *
     * @mbggenerated
     */
    ...
    /**
     * @return jsspdpks_lottery_sg.open_status: 状态：WAIT 等待开奖 | AUTO 自动开奖 | HANDLE 手动开奖
     *
     * @mbggenerated
     */
    ...
    public boolean equals(Object that) {
        ...
        JsspdpksLotterySg other = (JsspdpksLotterySg) that;
