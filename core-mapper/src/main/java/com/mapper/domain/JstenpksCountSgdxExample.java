...
public class JstenpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JstenpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JstenpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jstenpks_count_sgdx
     *
     * @mbggenerated
     */
