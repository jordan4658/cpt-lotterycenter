...
public class JsluckpksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsluckpksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public JsluckpksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsluckpks_count_sglh
     *
     * @mbggenerated
     */
