...
public class JsluckpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsluckpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public JsluckpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsluckpks_count_sgdx
     *
     * @mbggenerated
     */
