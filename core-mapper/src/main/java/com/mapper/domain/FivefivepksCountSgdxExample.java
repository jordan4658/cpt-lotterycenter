...
public class FivefivepksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivefivepksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FivefivepksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivefivepks_count_sgdx
     *
     * @mbggenerated
     */
