...
public class TenfivepksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenfivepksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public TenfivepksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenfivepks_count_sglh
     *
     * @mbggenerated
     */
