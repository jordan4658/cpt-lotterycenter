...
public class FivepksCountSglhExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivepksCountSglhExample() {
     ...
     * @mbggenerated
     */
    public FivepksCountSglhExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivepks_count_sglh
     *
     * @mbggenerated
     */
