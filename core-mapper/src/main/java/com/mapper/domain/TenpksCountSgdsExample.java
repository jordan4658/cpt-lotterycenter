...
public class TenpksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenpksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenpks_count_sgds
     *
     * @mbggenerated
     */
