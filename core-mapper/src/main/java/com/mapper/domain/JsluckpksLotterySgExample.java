...
public class JsluckpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsluckpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JsluckpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsluckpks_lottery_sg
     *
     * @mbggenerated
     */
