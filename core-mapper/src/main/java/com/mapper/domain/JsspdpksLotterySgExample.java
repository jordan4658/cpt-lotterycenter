...
public class JsspdpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsspdpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JsspdpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsspdpks_lottery_sg
     *
     * @mbggenerated
     */
