...
public class JsfivepksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsfivepksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public JsfivepksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsfivepks_count_sgds
     *
     * @mbggenerated
     */
