...
public class JsspdpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JsspdpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public JsspdpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jsspdpks_kill_number
     *
     * @mbggenerated
     */
