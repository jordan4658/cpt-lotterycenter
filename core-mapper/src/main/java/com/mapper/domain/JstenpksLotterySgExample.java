...
public class JstenpksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public JstenpksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public JstenpksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table jstenpks_lottery_sg
     *
     * @mbggenerated
     */
