...
public class FtxyftCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FtxyftCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table ftxyft_count_sgdx
     *
     * @mbggenerated
     */
