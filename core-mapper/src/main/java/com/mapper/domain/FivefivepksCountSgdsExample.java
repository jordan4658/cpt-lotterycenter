...
public class FivefivepksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivefivepksCountSgdsExample() {
     ...
     * @mbggenerated
     */
    public FivefivepksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivefivepks_count_sgds
     *
     * @mbggenerated
     */
