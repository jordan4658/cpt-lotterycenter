...
public class AuspksCountSgdsExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public AuspksCountSgdsExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table auspks_count_sgds
     *
     * @mbggenerated
     */
