...
public class TenauspksLotterySgExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public TenauspksLotterySgExample() {
     ...
     * @mbggenerated
     */
    public TenauspksLotterySgExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table tenauspks_lottery_sg
     *
     * @mbggenerated
     */
