...
public class FivetenpksCountSgdxExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public FivetenpksCountSgdxExample() {
     ...
     * @mbggenerated
     */
    public FivetenpksCountSgdxExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table fivetenpks_count_sgdx
     *
     * @mbggenerated
     */
