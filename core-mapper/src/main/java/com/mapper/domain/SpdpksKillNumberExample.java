...
public class SpdpksKillNumberExample implements Serializable {
    /**
     ...
     * @mbggenerated
     */
    public SpdpksKillNumberExample() {
     ...
     * @mbggenerated
     */
    public SpdpksKillNumberExample bound(Integer offset, Integer limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
     ...
     * This class corresponds to the database table spdpks_kill_number
     *
     * @mbggenerated
     */
