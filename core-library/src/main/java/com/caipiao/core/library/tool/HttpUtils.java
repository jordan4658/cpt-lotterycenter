...
public abstract class HttpUtils {
    ...
    private static final int MAX_TIMEOUT = 27000;
    ...
    private static String doPost(String url, Map<String, String> params, String charset,
        ...
        return _doPost(url, ctype, content, headerMap);
    }
     ...
     * @return 响应字符串
     */
    private static String doGet(String url, Map<String, String> params, String charset, Integer timeOut) throws IOException {
        HttpURLConnection conn = null;
        String rsp = null;
     ...
     * @return 响应字符串
     */
    private static String doGet(String url, Map<String, String> params, String charset, Integer timeOut,String userAgent) throws IOException {
        HttpURLConnection conn = null;
        String rsp = null;
    ...
    * @throws IOException
    */
   public static String doGetUseTimeOutAndAgent(String url, Integer timeOut,String userAgent) throws IOException {
       return doGet(url, null, DEFAULT_CHARSET, timeOut, userAgent);
   }
}