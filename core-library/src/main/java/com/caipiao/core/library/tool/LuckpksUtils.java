...
import com.caipiao.core.library.dto.result.LuckpksGuanYaHeCountDTO;
import com.caipiao.core.library.dto.result.LuckpksLiangMian;
...
public class LuckpksUtils {
    ...
    public static Map<String, ThereMemberListVO> luzhuLiangMian(List<String> sg, String countType) {
        ...
        if (LotteryInformationType.LUCKPKS_LMLZ_DX.equals(countType)) {
            //统计两面路珠之大小
            for (int i = 0; i < totalIssue; i++) {
                String number = sg.get(i);
                String[] numStr = number.split(",");
        ...
        } else if (LotteryInformationType.LUCKPKS_LMLZ_DS.equals(countType)) {
            //统计两面路珠之单双
            for (int i = 0; i < totalIssue; i++) {
                String number = sg.get(i);
                String[] numStr = number.split(",");
        ...
        } else if (LotteryInformationType.LUCKPKS_LMLZ_LH.equals(countType)) {
            //统计两面路珠之龙虎
            for (int i = 0; i < totalIssue; i++) {
                String number = sg.get(i);
                String[] numStr = number.split(",");
        ...
        HashMap<String, ThereMemberListVO> map = new HashMap<>();
        int len = 10;
        if (LotteryInformationType.LUCKPKS_LMLZ_LH.equals(countType)) {
            len = 5;
        }
        for (int x = 0; x < len; x++) {
            map.put(num[x], new ThereMemberListVO(count[(x * 2)], count[(x * 2 + 1)], lists.get(x)));
     ...
     * @return
     */
    public static List<KjlsVO> historySg(List<LuckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
     ...
     * @return
     */
    public static List<Map<String, Object>> lishiSg(List<LuckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
        int totalIssue = sgs.size();
     ...
     * @return
     */
    public static LuckpksCountSgdx countSgDx(List<LuckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        LuckpksCountSgdx countSgdx = new LuckpksCountSgdx();
        LuckpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static TenluckpksCountSgdx countSgDxTen(List<TenluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenluckpksCountSgdx countSgdx = new TenluckpksCountSgdx();
        TenluckpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            TenluckpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static FiveluckpksCountSgdx countSgDxFive(List<FiveluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FiveluckpksCountSgdx countSgdx = new FiveluckpksCountSgdx();
        FiveluckpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
        	FiveluckpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static JsluckpksCountSgdx countSgDxJs(List<JsluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsluckpksCountSgdx countSgdx = new JsluckpksCountSgdx();
        JsluckpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            JsluckpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static LuckpksCountSgds countSgDs(List<LuckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        LuckpksCountSgds countSgds = new LuckpksCountSgds();
        LuckpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static TenluckpksCountSgds countSgDsTen(List<TenluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenluckpksCountSgds countSgds = new TenluckpksCountSgds();
        TenluckpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static FiveluckpksCountSgds countSgDsFive(List<FiveluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FiveluckpksCountSgds countSgds = new FiveluckpksCountSgds();
        FiveluckpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static JsluckpksCountSgds countSgDsJs(List<JsluckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsluckpksCountSgds countSgds = new JsluckpksCountSgds();
        JsluckpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static LuckpksCountSglh countSgLh(List<LuckpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        LuckpksCountSglh countSglh = new LuckpksCountSglh();
        LuckpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
	public static TenluckpksCountSglh countSgLhTen(List<TenluckpksLotterySg> sgs) {
		if (sgs == null) {
			return null;
		}

		TenluckpksCountSglh countSglh = new TenluckpksCountSglh();
		TenluckpksLotterySg sg1 = sgs.get(0);
		countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static FiveluckpksCountSglh countSgLhFive(List<FiveluckpksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            FiveluckpksCountSglh countSglh = new FiveluckpksCountSglh();
            FiveluckpksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static JsluckpksCountSglh countSgLhJs(List<JsluckpksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            JsluckpksCountSglh countSglh = new JsluckpksCountSglh();
            JsluckpksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
     ...
     * @param countArr
     */
    public static void setCountDxData(LuckpksCountSgdx countSgdx, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDxData(TenluckpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(FiveluckpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(JsluckpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(LuckpksCountSgds countSgds, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDsData(TenluckpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(FiveluckpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(JsluckpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(LuckpksCountSglh countSglh, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountLhData(TenluckpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(FiveluckpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(JsluckpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
    ...
    public static LuckpksKillNumber getKillNumber(String issue) {
        LuckpksKillNumber luckpksKillNumber = new LuckpksKillNumber();
        luckpksKillNumber.setIssue(issue);
        ...
        luckpksKillNumber.setTime(time);
        luckpksKillNumber.setOne(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setTwo(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setThere(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setFour(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setFive(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setSix(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setSeven(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setEight(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setNine(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setTen(RandomUtils.getLuckpksKillNumber());
        luckpksKillNumber.setCreateTime(TimeHelper.date());
        return luckpksKillNumber;
    }
    
    public static TenluckpksKillNumber getTenKillNumber(String issue) {
    	TenluckpksKillNumber luckpksKillNumber = new TenluckpksKillNumber();
        luckpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
        if ("23:50".equals(time)) {
            time = "00:00:00";
    ...
    public static FiveluckpksKillNumber getFiveKillNumber(String issue) {
    	FiveluckpksKillNumber luckpksKillNumber = new FiveluckpksKillNumber();
        luckpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
    ...
    public static JsluckpksKillNumber getJsKillNumber(String issue) {
    	JsluckpksKillNumber luckpksKillNumber = new JsluckpksKillNumber();
        luckpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
     ...
     * 公式杀号
     */
    public static Map<String, Object> killNumber(List<LuckpksKillNumber> killNumbers, Integer position) {
        ...
        for (int i = killNumbers.size() - 1; i >= 0; i--) {
            LuckpksKillNumber killNumber = killNumbers.get(i);
            vo = new KillNumberVO();
     ...
     * @return
     */
    public static Map<String, Object> sgDetails(LuckpksLotterySg sg) {
        if (sg == null) {
            return null;
        }
    ...
    public static int nextIssue(String time, String issue) {
        ...
        long nextIssueTime = LuckpksUtils.nextIssueTime();
     ...
     * @return
     */
    public static Map<String, SscMissNumDTO> queryMissVal(List<LuckpksLotterySg> sg, Integer start, Integer end) {
     ...
     * @return
     */
    public static Map<String, LuckpksLiangMian> queryLiangMianMissVal(List<LuckpksLotterySg> sg) {
        Map<String, LuckpksLiangMian> map = new HashMap<>();
        if (sg == null) {
            return map;
        }
        ...
        map.put("0", new LuckpksLiangMian(arr[0], arr[1], arr[2], arr[3]));
        for (int j = 1; j < 6; j++) {
            int k = 6 * j - 2;
            map.put("" + j, new LuckpksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3], arr[k + 4], arr[k + 5]));
        }
        for (int j = 6; j < 11; j++) {
            int k = 4 * j + 10;
            map.put("" + j, new LuckpksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3]));
        }
        return map;
    }
     ...
     * @return
     */
    public static Integer getLuckpksMissingCount(int i, List<LuckpksLotterySg> luckpksLotterySg, int num) {
        int number = 0;
        for (int j = i; j < 200 && j < luckpksLotterySg.size(); j++) {
            //开奖号码
            String[] split = luckpksLotterySg.get(j).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getSumOpenCount(List<LuckpksLotterySg> luckpksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < luckpksLotterySg.size(); i++) {
            //开奖号码
            String[] split = luckpksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getNoOutOpenCount(List<LuckpksLotterySg> luckpksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < luckpksLotterySg.size(); i++) {
            //开奖号码
            String[] split = luckpksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Map<String, Object> queryTotal(List<LuckpksLotterySg> sgList) {
        if (sgList == null) {
            return null;
        }
        ...
        for (LuckpksLotterySg list : sgList) {
        ...
        LuckpksGuanYaHeCountDTO heCount = new LuckpksGuanYaHeCountDTO();
