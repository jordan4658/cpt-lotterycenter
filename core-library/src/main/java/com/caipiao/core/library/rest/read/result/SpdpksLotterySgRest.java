...
public interface SpdpksLotterySgRest {

    /**
     * 最近一期的开奖结果
     * @return
     */
    @PostMapping("/spdpksSg/getNewestSgInfo.json")
     ...
     * @return
     */    
    @PostMapping("/spdpksSg/historySg.json")
     ...
     * @return
     */
    @PostMapping("/spdpksSg/todayNumber.json")
     ...
     * @return
     */
    @PostMapping("/spdpksSg/killNumber.json")
