...
import com.caipiao.core.library.dto.result.XyftLiangMian;
...
//    }
    ...
    public static FtxyftKillNumber getFtxyKillNumber(String issue) {
        ...
        xyftKillNumber.setOne(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setTwo(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setThere(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setFour(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setFive(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setSix(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setSeven(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setEight(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setNine(RandomUtils.getXyftKillNumber());
        xyftKillNumber.setTen(RandomUtils.getXyftKillNumber());
     ...
     * @return
     */
    public static List<Map<String, Object>> lishiScSg(List<XyftscLotterySg> sgs) {
        List<Map<String, Object>> result = new ArrayList<>();
        if (CollectionUtils.isEmpty(sgs)) {
            return result;
        }
...
//            }
     ...
     * @return
     */
    public static List<KjlsVO> historyScSg(List<XyftscLotterySg> sgs) {
        ArrayList<KjlsVO> result = new ArrayList<>();
        if (CollectionUtils.isEmpty(sgs)) {
            return result;
        }
        ...
        for (int i = 0; i < totalIssue; i++) {
            ...
            result.add(new KjlsVO(sg.getIssue(), DateUtils.formatDate(sg.getTime(), DateUtils.FORMAT_YYYY_MM_DD_HHMMSS).substring(0, 10), DateUtils.formatDate(sg.getTime(), DateUtils.FORMAT_YYYY_MM_DD_HHMMSS).substring(11, 16), data));
        }
        return result;
    }
