...
import com.caipiao.core.library.dto.result.FivepksGuanYaHeCountDTO;
import com.caipiao.core.library.dto.result.FivepksLiangMian;
...
public class FivepksUtils {
     ...
     * @return
     */
    public static List<KjlsVO> historySg(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
     ...
     * @return
     */
    public static List<Map<String, Object>> lishiSg(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
        int totalIssue = sgs.size();
     ...
     * @return
     */
    public static FivepksCountSgdx countSgDx(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivepksCountSgdx countSgdx = new FivepksCountSgdx();
        FivepksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static FivepksCountSgdx countSgDxTen(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }
     ...
     * @return
     */
    public static FivefivepksCountSgdx countSgDxFive(List<FivefivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivefivepksCountSgdx countSgdx = new FivefivepksCountSgdx();
        FivefivepksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            FivefivepksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static JsfivepksCountSgdx countSgDxJs(List<JsfivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsfivepksCountSgdx countSgdx = new JsfivepksCountSgdx();
        JsfivepksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            JsfivepksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static FivepksCountSgds countSgDs(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivepksCountSgds countSgds = new FivepksCountSgds();
        FivepksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static TenfivepksCountSgds countSgDsTen(List<TenfivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenfivepksCountSgds countSgds = new TenfivepksCountSgds();
        TenfivepksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //单，双
        for (int i = 0; i < totalIssue; i++) {
            TenfivepksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static FivefivepksCountSgds countSgDsFive(List<FivefivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivefivepksCountSgds countSgds = new FivefivepksCountSgds();
        FivefivepksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static JsfivepksCountSgds countSgDsJs(List<JsfivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsfivepksCountSgds countSgds = new JsfivepksCountSgds();
        JsfivepksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static FivepksCountSglh countSgLh(List<FivepksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivepksCountSglh countSglh = new FivepksCountSglh();
        FivepksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
	public static TenfivepksCountSglh countSgLhTen(List<TenfivepksLotterySg> sgs) {
		if (sgs == null) {
			return null;
		}

		TenfivepksCountSglh countSglh = new TenfivepksCountSglh();
		TenfivepksLotterySg sg1 = sgs.get(0);
		countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static FivefivepksCountSglh countSgLhFive(List<FivefivepksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            FivefivepksCountSglh countSglh = new FivefivepksCountSglh();
            FivefivepksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static JsfivepksCountSglh countSgLhJs(List<JsfivepksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            JsfivepksCountSglh countSglh = new JsfivepksCountSglh();
            JsfivepksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
     ...
     * @param countArr
     */
    public static void setCountDxData(FivepksCountSgdx countSgdx, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDxData(FivefivepksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(JsfivepksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(FivepksCountSgds countSgds, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDsData(TenfivepksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(FivefivepksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(JsfivepksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(FivepksCountSglh countSglh, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountLhData(TenfivepksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(FivefivepksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(JsfivepksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
    ...
    public static FivepksKillNumber getKillNumber(String issue) {
        FivepksKillNumber fivepksKillNumber = new FivepksKillNumber();
        fivepksKillNumber.setIssue(issue);
        ...
        fivepksKillNumber.setTime(time);
        fivepksKillNumber.setOne(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setTwo(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setThere(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setFour(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setFive(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setSix(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setSeven(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setEight(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setNine(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setTen(RandomUtils.getFivepksKillNumber());
        fivepksKillNumber.setCreateTime(TimeHelper.date());
        return fivepksKillNumber;
    }
    
    public static TenfivepksKillNumber getTenKillNumber(String issue) {
    	TenfivepksKillNumber fivepksKillNumber = new TenfivepksKillNumber();
    	fivepksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
        if ("23:50".equals(time)) {
            time = "00:00:00";
    ...
    public static FivefivepksKillNumber getFiveKillNumber(String issue) {
    	FivefivepksKillNumber fivepksKillNumber = new FivefivepksKillNumber();
        fivepksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
    ...
    public static JsfivepksKillNumber getJsKillNumber(String issue) {
    	JsfivepksKillNumber fivepksKillNumber = new JsfivepksKillNumber();
        fivepksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
     ...
     * 公式杀号
     */
    public static Map<String, Object> killNumber(List<FivepksKillNumber> killNumbers, Integer position) {
        ...
        for (int i = killNumbers.size() - 1; i >= 0; i--) {
            FivepksKillNumber killNumber = killNumbers.get(i);
            vo = new KillNumberVO();
     ...
     * @return
     */
    public static Map<String, Object> sgDetails(FivepksLotterySg sg) {
        if (sg == null) {
            return null;
        }
     ...
     * @return
     */
    public static Map<String, SscMissNumDTO> queryMissVal(List<FivepksLotterySg> sg, Integer start, Integer end) {
     ...
     * @return
     */
    public static Map<String, FivepksLiangMian> queryLiangMianMissVal(List<FivepksLotterySg> sg) {
        Map<String, FivepksLiangMian> map = new HashMap<>();
        if (sg == null) {
            return map;
        }
        ...
        map.put("0", new FivepksLiangMian(arr[0], arr[1], arr[2], arr[3]));
        for (int j = 1; j < 6; j++) {
            int k = 6 * j - 2;
            map.put("" + j, new FivepksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3], arr[k + 4], arr[k + 5]));
        }
        for (int j = 6; j < 11; j++) {
            int k = 4 * j + 10;
            map.put("" + j, new FivepksLiangMian(arr[k], arr[k + 1], arr[k + 2], arr[k + 3]));
        }
        return map;
    }
     ...
     * @return
     */
    public static Integer getTenpksMissingCount(int i, List<FivepksLotterySg> fivepksLotterySg, int num) {
        int number = 0;
        for (int j = i; j < 200 && j < fivepksLotterySg.size(); j++) {
            //开奖号码
            String[] split = fivepksLotterySg.get(j).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getSumOpenCount(List<FivepksLotterySg> fivepksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < fivepksLotterySg.size(); i++) {
            //开奖号码
            String[] split = fivepksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Integer getNoOutOpenCount(List<FivepksLotterySg> fivepksLotterySg, int number) {
        int count = 0;
        for (int i = 0; i < fivepksLotterySg.size(); i++) {
            //开奖号码
            String[] split = fivepksLotterySg.get(i).getNumber().split(",");
     ...
     * @return
     */
    public static Map<String, Object> queryTotal(List<FivepksLotterySg> sgList) {
        if (sgList == null) {
            return null;
        }
        ...
        for (FivepksLotterySg list : sgList) {
        ...
        FivepksGuanYaHeCountDTO heCount = new FivepksGuanYaHeCountDTO();
