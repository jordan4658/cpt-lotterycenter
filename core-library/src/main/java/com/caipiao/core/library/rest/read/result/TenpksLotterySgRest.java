...
public interface TenpksLotterySgRest {

    /**
     * 最近一期的开奖结果
     * @return
     */
    @PostMapping("/tenpksSg/getNewestSgInfo.json")
     ...
     * @return
     */    
    @PostMapping("/tenpksSg/historySg.json")
     ...
     * @return
     */
    @PostMapping("/tenpksSg/todayNumber.json")
     ...
     * @return
     */
    @PostMapping("/tenpksSg/killNumber.json")
