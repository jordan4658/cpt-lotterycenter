...
import com.caipiao.core.library.dto.result.BjpksGuanYaHeCountDTO;
...
public class BjpksUtils {
     ...
     * @return
     */
    public static BjpksCountSgdx countSgDx(List<BjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        BjpksCountSgdx countSgdx = new BjpksCountSgdx();
        BjpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static TenbjpksCountSgdx countSgDxTen(List<TenbjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenbjpksCountSgdx countSgdx = new TenbjpksCountSgdx();
        TenbjpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            TenbjpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static FivebjpksCountSgdx countSgDxFive(List<FivebjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivebjpksCountSgdx countSgdx = new FivebjpksCountSgdx();
        FivebjpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            FivebjpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static JsbjpksCountSgdx countSgDxJs(List<JsbjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsbjpksCountSgdx countSgdx = new JsbjpksCountSgdx();
        JsbjpksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            JsbjpksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static BjpksCountSgds countSgDs(List<BjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        BjpksCountSgds countSgds = new BjpksCountSgds();
        BjpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static TenbjpksCountSgds countSgDsTen(List<TenbjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenbjpksCountSgds countSgds = new TenbjpksCountSgds();
        TenbjpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static FivebjpksCountSgds countSgDsFive(List<FivebjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FivebjpksCountSgds countSgds = new FivebjpksCountSgds();
        FivebjpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static JsbjpksCountSgds countSgDsJs(List<JsbjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsbjpksCountSgds countSgds = new JsbjpksCountSgds();
        JsbjpksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static BjpksCountSglh countSgLh(List<BjpksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        BjpksCountSglh countSglh = new BjpksCountSglh();
        BjpksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
	public static TenbjpksCountSglh countSgLhTen(List<TenbjpksLotterySg> sgs) {
		if (sgs == null) {
			return null;
		}

		TenbjpksCountSglh countSglh = new TenbjpksCountSglh();
		TenbjpksLotterySg sg1 = sgs.get(0);
		countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static FivebjpksCountSglh countSgLhFive(List<FivebjpksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            FivebjpksCountSglh countSglh = new FivebjpksCountSglh();
            FivebjpksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static JsbjpksCountSglh countSgLhJs(List<JsbjpksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            JsbjpksCountSglh countSglh = new JsbjpksCountSglh();
            JsbjpksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
     ...
     * @param countArr
     */
    public static void setCountDxData(BjpksCountSgdx countSgdx, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDxData(TenbjpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(FivebjpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(JsbjpksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(BjpksCountSgds countSgds, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountDsData(TenbjpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(FivebjpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(JsbjpksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(BjpksCountSglh countSglh, int[] countArr) {
     ...
     * @param countArr
     */
    public static void setCountLhData(TenbjpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(FivebjpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(JsbjpksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
    ...
    public static BjpksKillNumber getKillNumber(String issue) {
        BjpksKillNumber bjpksKillNumber = new BjpksKillNumber();
        bjpksKillNumber.setIssue(issue);
        ...
        bjpksKillNumber.setTime(time);
        bjpksKillNumber.setOne(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setTwo(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setThere(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setFour(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setFive(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setSix(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setSeven(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setEight(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setNine(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setTen(RandomUtils.getBjpksKillNumber());
        bjpksKillNumber.setCreateTime(TimeHelper.date());
        return bjpksKillNumber;
    }
    
    public static TenbjpksKillNumber getTenKillNumber(String issue) {
    	TenbjpksKillNumber bjpksKillNumber = new TenbjpksKillNumber();
        bjpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
        if ("23:50".equals(time)) {
            time = "00:00:00";
    ...
    public static FivebjpksKillNumber getFiveKillNumber(String issue) {
    	FivebjpksKillNumber bjpksKillNumber = new FivebjpksKillNumber();
        bjpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
    ...
    public static JsbjpksKillNumber getJsKillNumber(String issue) {
    	JsbjpksKillNumber bjpksKillNumber = new JsbjpksKillNumber();
        bjpksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
     ...
     * 公式杀号
     */
    public static Map<String, Object> killNumber(List<BjpksKillNumber> killNumbers, Integer position) {
        ...
        for (int i = killNumbers.size() - 1; i >= 0; i--) {
            BjpksKillNumber killNumber = killNumbers.get(i);
            vo = new KillNumberVO();
