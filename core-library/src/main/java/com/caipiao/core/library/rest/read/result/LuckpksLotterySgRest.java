...
public interface LuckpksLotterySgRest {

    /**
     * 最近一期的开奖结果
     * @return
     */
    @PostMapping("/luckpksSg/getNewestSgInfo.json")
     ...
     * @return
     */    
    @PostMapping("/luckpksSg/historySg.json")
     ...
     * @return
     */
    @PostMapping("/luckpksSg/todayNumber.json")
     ...
     * @return
     */
    @PostMapping("/luckpksSg/killNumber.json")
