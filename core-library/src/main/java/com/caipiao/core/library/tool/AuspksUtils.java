...
import com.caipiao.core.library.dto.result.AuspksGuanYaHeCountDTO;
import com.caipiao.core.library.dto.result.AuspksLiangMian;
...
public class AuspksUtils {
    ...
    public static AuspksCountSgdx countSgDx(List<AuspksLotterySg> sgs) {
        ...
        Date openDate = DateUtils.parseDate(sg1.getTime(), datePattern);
        countSgdx.setTotalDate(openDate);
     ...
     * @return
     */
    public static TenauspksCountSgdx countSgDxTen(List<TenauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenauspksCountSgdx countSgdx = new TenauspksCountSgdx();
        TenauspksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            TenauspksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static FiveauspksCountSgdx countSgDxFive(List<FiveauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FiveauspksCountSgdx countSgdx = new FiveauspksCountSgdx();
        FiveauspksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            FiveauspksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
     ...
     * @return
     */
    public static JsauspksCountSgdx countSgDxJs(List<JsauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsauspksCountSgdx countSgdx = new JsauspksCountSgdx();
        JsauspksLotterySg sg1 = sgs.get(0);
        countSgdx.setDate(sg1.getTime().substring(0, 10));

        int totalIssue = sgs.size();
        int[] count = new int[20]; //大，小
        for (int i = 0; i < totalIssue; i++) {
            JsauspksLotterySg sg = sgs.get(i);
            String numStr = sg.getNumber();
            String[] numStrArr = numStr.split(",");
            for (int j = 0; j < 10; j++) {
                int num = Integer.valueOf(numStrArr[j]);
    ...
    public static AuspksCountSgds countSgDs(List<AuspksLotterySg> sgs) {
        ...
        AuspksLotterySg sg1 = sgs.get(0);
        Date openDate = DateUtils.parseDate(sg1.getTime(), datePattern);
        countSgds.setTotalDate(openDate);
     ...
     * @return
     */
    public static TenauspksCountSgds countSgDsTen(List<TenauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        TenauspksCountSgds countSgds = new TenauspksCountSgds();
        TenauspksLotterySg sg1 = sgs.get(0);
     ...
     * @return
     */
    public static FiveauspksCountSgds countSgDsFive(List<FiveauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        FiveauspksCountSgds countSgds = new FiveauspksCountSgds();
        FiveauspksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
     ...
     * @return
     */
    public static JsauspksCountSgds countSgDsJs(List<JsauspksLotterySg> sgs) {
        if (sgs == null) {
            return null;
        }

        JsauspksCountSgds countSgds = new JsauspksCountSgds();
        JsauspksLotterySg sg1 = sgs.get(0);
        countSgds.setDate(sg1.getTime().substring(0, 10));
    ...
    public static AuspksCountSglh countSgLh(List<AuspksLotterySg> sgs) {
        ...
        AuspksLotterySg sg1 = sgs.get(0);        
        Date openDate = DateUtils.parseDate(sg1.getTime(), datePattern);
        countSglh.setTotalDate(openDate);
        int totalIssue = sgs.size();
     ...
     * @return
     */
	public static TenauspksCountSglh countSgLhTen(List<TenauspksLotterySg> sgs) {
		if (sgs == null) {
			return null;
		}

		TenauspksCountSglh countSglh = new TenauspksCountSglh();
		TenauspksLotterySg sg1 = sgs.get(0);
         ...
         * @return
         */
        public static FiveauspksCountSglh countSgLhFive(List<FiveauspksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            FiveauspksCountSglh countSglh = new FiveauspksCountSglh();
            FiveauspksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
         ...
         * @return
         */
        public static JsauspksCountSglh countSgLhJs(List<JsauspksLotterySg> sgs) {
            if (sgs == null) {
                return null;
            }

            JsauspksCountSglh countSglh = new JsauspksCountSglh();
            JsauspksLotterySg sg1 = sgs.get(0);
            countSglh.setDate(sg1.getTime().substring(0, 10));
     ...
     * @param countArr
     */
    public static void setCountDxData(AuspksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            ...
            countSgdx.setCreateTime(new Date());
        }
    }
     ...
     * @param countArr
     */
    public static void setCountDxData(TenauspksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(FiveauspksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDxData(JsauspksCountSgdx countSgdx, int[] countArr) {
        if (countSgdx != null && countArr.length >= 20) {
            countSgdx.setOned(countArr[0]);
            countSgdx.setOnex(countArr[1]);
            countSgdx.setTwod(countArr[2]);
    ...
    public static void setCountDsData(AuspksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            ...
            countSgds.setCreateTime(new Date());
        }
    }
     ...
     * @param countArr
     */
    public static void setCountDsData(TenauspksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountDsData(FiveauspksCountSgds countSgds, int[] countArr) {
        if (countSgds != null && countArr.length >= 20) {
            countSgds.setOned(countArr[0]);
            countSgds.setOnes(countArr[1]);
            countSgds.setTwod(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(AuspksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            ...
            countSglh.setCreateTime(new Date());
        }
    }
     ...
     * @param countArr
     */
    public static void setCountLhData(TenauspksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(FiveauspksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
     ...
     * @param countArr
     */
    public static void setCountLhData(JsauspksCountSglh countSglh, int[] countArr) {
        if (countSglh != null && countArr.length >= 10) {
            countSglh.setOnel(countArr[0]);
            countSglh.setOneh(countArr[1]);
            countSglh.setTwol(countArr[2]);
	 ...
	 * @return
	 */
    public static AuspksKillNumber getKillNumber(String issue) {
        AuspksKillNumber auspksKillNumber = new AuspksKillNumber();
        auspksKillNumber.setIssue(issue);

        auspksKillNumber.setOne(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setTwo(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setThere(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setFour(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setFive(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setSix(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setSeven(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setEight(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setNine(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setTen(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setCreateTime(new Date());
        return auspksKillNumber;
    }
    
    public static TenauspksKillNumber getTenKillNumber(String issue) {
    	TenauspksKillNumber auspksKillNumber = new TenauspksKillNumber();
        auspksKillNumber.setIssue(issue);
        ...
        auspksKillNumber.setNine(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setTen(RandomUtils.getAuspksKillNumber());
        auspksKillNumber.setCreateTime(TimeHelper.date());
        return auspksKillNumber;
    }
    
    public static FiveauspksKillNumber getFiveKillNumber(String issue) {
    	FiveauspksKillNumber auspksKillNumber = new FiveauspksKillNumber();
        auspksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
    ...
    public static JsauspksKillNumber getJsKillNumber(String issue) {
    	JsauspksKillNumber auspksKillNumber = new JsauspksKillNumber();
        auspksKillNumber.setIssue(issue);
        String time = DateUtils.formatDate(new Date(), "HH:mm");
	 ...
	 * 公式杀号
	 */
    public static Map<String, Object> killNumber(List<AuspksKillNumber> killNumbers, Integer position) {
        ...
        for (int i = killNumbers.size() - 1; i >= 0; i--) {
            AuspksKillNumber killNumber = killNumbers.get(i);
            vo = new KillNumberVO();
            vo.setIssue(killNumber.getIssue());
            vo.setTime(killNumber.getOpenNumber());
            ...
            // 开奖号码
            String number = killNumber.getOpenNumber();
            // 判断是否已开奖
