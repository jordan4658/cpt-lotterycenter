...
public class BetSscUtil {
        ...
        if(betNumber.contains("@")){
            ...
            switch (qian) {
                ...
                default:
                    ...
                    String longhuhe=Integer.valueOf(numStr[0])>Integer.valueOf(numStr[4])?"龙":Integer.valueOf(numStr[0])==Integer.valueOf(numStr[4])?"和":"虎";
                    String s = betarr[1];
    ...
    public static Boolean isWinBy15(String betNumber, String number) {
        if(betNumber.contains("@")){
            String[] betarr = betNumber.split("@");
            String qian=betarr[0];
            ...
            String[] numStr = number.split(",");
            Integer num;
            if(stringBetNum.equals("大") || stringBetNum.equals("小") || stringBetNum.equals("单") || stringBetNum.equals("双")){
                switch (qian) {
                    case "第一球":
                        num = Integer.valueOf(numStr[0]);
                        break;
                ...
                if((stringBetNum.equals("大") && num > 4)
                        || (stringBetNum.equals("小") && num <= 4)
                        || (stringBetNum.equals("单") && num % 2 != 0)
                        || (stringBetNum.equals("双") && num % 2 == 0)) {
                    return true;
                }
                return false;
