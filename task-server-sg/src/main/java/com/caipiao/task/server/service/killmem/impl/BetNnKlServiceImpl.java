...
import com.caipiao.task.server.service.killmem.BetNnKlService;
...
@Service
@Transactional
public class BetNnKlServiceImpl implements BetNnKlService {

    //日志输出对象
    private static final Logger logger = LoggerFactory.getLogger(BetNnKlServiceImpl.class);
...
//        System.out.println(winOrNot("闲一","0,2,3,8,9"));
//        System.out.println(winOrNot("闲一","0,2,3,8,9"));
//        System.out.println(winOrNot("闲二","0,2,3,8,9"));
//        System.out.println(winOrNot("闲三","0,2,3,8,9"));
//        System.out.println(winOrNot("闲四","0,2,3,8,9"));
//        System.out.println(winOrNot("闲四","0,2,3,8,9"));
//
//    }
