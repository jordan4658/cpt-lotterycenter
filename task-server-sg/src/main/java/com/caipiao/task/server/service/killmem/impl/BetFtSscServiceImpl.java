...
import com.caipiao.task.server.service.killmem.BetFtSscService;
...
@Service
public class BetFtSscServiceImpl implements BetFtSscService {




	// 极速时时彩番摊 返回值 0 表示输
	public static final Integer PLAY_ID_FH_ZERO = 0;
	// 极速时时彩番摊 返回值 1 表示赢
	public static final Integer PLAY_ID_FH_ONE = 1;
	// 极速时时彩番摊 返回值 2 表示 和(走水）
	public static final Integer PLAY_ID_FH_TWO = 2;
	// 极速时时彩番摊值 1
	...
	// 极速时时彩番摊玩法ID集合
	public static final List<Integer> playIdList= Lists.newArrayList(200301);
	...
	public Integer isWin(String betNumber, String number) {
		...
		Integer num = Integer.valueOf(FanTanCalculationUtils.ftjssscSaleResult(number));
